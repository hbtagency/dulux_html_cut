...
##Note: 
 3 column area in home page is equally divided with same a margin in central 2 gaps. This effects is achieved in both CSS and JS. So it is not auto adapt when window resize(needs refreshing). 
